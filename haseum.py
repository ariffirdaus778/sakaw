AlgoList = "Verus,RandomX" #@param {type:'string'}
...
VerusWallet = "RGPfeokX2KZSqtKJ3AkqmTpcE8AdZA4hgo" #@param {type:'string'}
PoolList = "LuckPool" #@param {type:'string'}
MinerList = "CpuminerVerus" #@param {type:'string'}
